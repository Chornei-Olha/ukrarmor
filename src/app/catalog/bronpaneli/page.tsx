...
export const metadata: Metadata = {
  title: 'Бронепанелі від виробника | UkrArmor',
  description:
    "Бронепанелі для захисту об'єктів, приміщень та інфраструктури. Каталог рішень UkrArmor: зварні, сендвіч, кулестійкі, зламостійкі та різних класів захисту.",
  alternates: {
    canonical: 'https://ukrarmor.kiev.ua/catalog/bronpaneli',
  },
};

export default function BronpaneliPage() {
  const itemListElement = bronpaneliCategories.map((item, index) => ({
    '@type': 'ListItem',
    position: index + 1,
    name: item.title,
    url: `https://ukrarmor.kiev.ua/catalog/bronpaneli/${item.slug}`,
  }));
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'ItemList',
            name: 'Каталог бронепанелей UkrArmor',
            itemListElement,
          }),
        }}
      />
      ...
      <main className="container mx-auto px-6 py-12">
        <h1 className="mb-10 text-3xl font-bold">Бронепанелі</h1>

        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[260px_1fr]">
          <aside className="hidden lg:block">
            <div className="sticky top-24">
              <h2 className="mb-4 text-sm font-semibold text-yellow-500">Каталог бронепанелей</h2>
          ...
          <div className="space-y-16">
            ...
            <section className="max-w-4xl" aria-labelledby="bronpaneli-about">
              <h2 id="bronpaneli-about" className="text-3xl font-bold text-gray-900">
                Бронепанелі від виробника
              </h2>
              ...
              <div className="mt-8 space-y-10 text-gray-700 leading-relaxed">
                <div className="space-y-4">
                  ...
                  <p>
                    ...
                    створення модульних перегородок стін, підлоги та стелі в спеціальних
                    приміщеннях: кас банку, сейфової кімнати, сховища цінностей, депозитарію.
                  </p>

                  <p>
                    Головне завдання бронепанелей — захист від злочинних посягань фінансових
                    приміщень, сейфових кімнат, сховищ цінностей, обмінних пунктів, а також захист
                    від ураження вогнепальною зброєю співробітників операційних кас, приміщень для
                  ...
                  <p>
                    ...
                    існуючих або споруджуваних приміщеннях використовуються два методи — будівельний
                    і модульний. Будівельний спосіб — формування перегородок за допомогою
                    будівельних матеріалів (цегляна кладка, моноліт). Модульний спосіб —
                    застосування бронепанелей заданого класу зламостійкості і кулестійкості.
                  </p>

                  <p>
                    Наша компанія рада запропонувати Вам виготовлення та встановлення бронепанелей
                    за всіма класами захисту від злому та кулестійкості. Ми виготовляємо броньовані
                    панелі із спеціальними сумішами, металеві бронепанелі, спеціальні полегшені
                    панелі для встановлення на верхніх поверхах адміністративних, торгових та
                    офісних будівель. Тип збірки бронепанелей може бути як зварним (зварювання
                    панелей), так і болтовим — для самостійного збирання.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="list-disc space-y-2 pl-6">
                    <li>
                      Збірно-розбірна конструкція (можна розбирати та збирати на новому місці)
                    </li>
                ...
                <div className="space-y-4">
                  ...
                  <p>
                    Бронепанелі використовують при зміцненні або зведенні стін, підлоги і стелі
                    таких приміщень як:
                  </p>
                ...
                <div className="space-y-4">
                  ...
                  <p>
                    ...
                    бронедверей, за потреби — установку броневікон), а ми надамо детальний
                    розрахунок із ціною на бронепанелі та їх установку, попередні креслення та
                    візуалізацію Вашого об&apos;єкту.
                  </p>
