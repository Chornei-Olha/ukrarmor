    ...
    <section className="w-full px-6 md:px-12 py-6 md:py-12">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Колонка 1 */}
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Твердотільне моделювання</h3>
          ...
          {/* Колонка 2 */}
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Балочне представлення</h3>
            <p className="text-base sm:text-lg text-gray-600 mb-4">
          ...
          {/* Колонка 3 */}
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Мембранне представлення</h3>
            <p className="text-base sm:text-lg text-gray-600 mb-4">
