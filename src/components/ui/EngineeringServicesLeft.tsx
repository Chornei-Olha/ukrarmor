...
export function EngineeringServicesLeft() {
  return (
    <section className="relative w-full bg-white py-20 px-4 md:px-10">
      <div className="mx-auto container">
        <h2 className="mb-14 text-center font-heading text-3xl md:text-4xl font-bold text-blue-700">
            ...
            <div key={idx} className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-700 text-white text-sm font-bold">
                    {item.step}
                  </span>
              ...
              {/* Image */}
              <div className="relative h-56 md:h-72 w-full rounded-2xl overflow-hidden shadow-lg">
